...
- The list of subcommands / verbs and their entry handlers. **If there are 10+ subcommands, list only the most-used 5–7 in PROJECT_SUMMARY** and reference the full set in `conventions.md` (or in the relevant deep-dive). Long verb tables in the top-level summary are noise.
